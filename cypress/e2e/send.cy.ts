describe("go through send wizard", () => {
  ...
  it("works through main page", () => {
    ...
    // Stäng wizard efter att vi har gått igenom alla steg
    cy.get('[data-testid="wizard-next-button"]').click();
  });

  it("works through send page", () => {
    cy.visit("http://localhost:4173/laddaupp");
...
function wizardHappyFlow() {
  ...
  cy.get('[data-testid="validate-report-kontrollresultat"]').should(
    "have.text",
